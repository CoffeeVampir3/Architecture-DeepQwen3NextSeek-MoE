...
class Qwen3NextGatedDeltaNet(nn.Module):
    def __init__(self, config, layer_idx):
        ...
        self.num_v_heads = config.num_gdn_v_heads
        self.num_k_heads = config.num_gdn_k_heads
        self.head_k_dim = config.gdn_k_head_dim
        self.head_v_dim = config.gdn_v_head_dim
